...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var zh = {
      ...
      "card.tools": "模型工具：compliance_report / compliance_redact / compliance_audit / compliance_scan / compliance_data_export / compliance_data_erase",
    ...
    var en = {
      ...
      "card.tools": "Model tools: compliance_report / compliance_redact / compliance_audit / compliance_scan / compliance_data_export / compliance_data_erase",
